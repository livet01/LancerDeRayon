...
public class FileTreePanel extends JPanel {
	...
	public FileTreePanel() {
		...
		// On se positionne dans le dossier rendu
		FileTreeNode rootTreeNode = new FileTreeNode(new File("rendu"),true,null);
		...
		tree.addTreeSelectionListener(new TreeSelectionListener() {
			public void valueChanged(TreeSelectionEvent e) {
			    ...
			    if(file.isFile() && file.getName().substring(file.getName().lastIndexOf(".")).equals(".ppm")) {
			    	try{
				    	peinture.set(JAI.create("fileload", file.toString()));
			    	}
			    	catch(Exception e1) {
